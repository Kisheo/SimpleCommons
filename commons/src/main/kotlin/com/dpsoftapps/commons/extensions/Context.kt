...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.dpsoftapps.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.dpsoftapps.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.dpsoftapps.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.dpsoftapps."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.dpsoftapps.contacts") && !packageName.startsWith("com.dpsoftapps.dialer")) {
        true
    } else if ((packageName.startsWith("com.dpsoftapps.contacts") || packageName.startsWith("com.dpsoftapps.dialer")) && isQPlus()) {
