...
import com.dpsoftapps.commons.asynctasks.CopyMoveTask
...
import com.dpsoftapps.commons.interfaces.CopyMoveListener
...
/*   todo     if (!packageName.startsWith("com.dpsoftapps.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app. For your own safety download the original one from www.dpsoftapps.com. Thanks"
