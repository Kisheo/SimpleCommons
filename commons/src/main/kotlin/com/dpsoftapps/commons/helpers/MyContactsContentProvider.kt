...
import com.dpsoftapps.commons.extensions.getIntValue
import com.dpsoftapps.commons.extensions.getStringValue
import com.dpsoftapps.commons.models.PhoneNumber
import com.dpsoftapps.commons.models.SimpleContact
import com.dpsoftapps.commons.models.contacts.Contact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.dpsoftapps.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.dpsoftapps.dialer" && packageName != "com.dpsoftapps.smsmessenger" && packageName != "com.dpsoftapps.calendar.pro") {
                return contacts
            }
